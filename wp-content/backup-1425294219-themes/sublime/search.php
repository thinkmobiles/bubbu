...
if ($posttags) {?>
    ...
    <h4>
      <?php _e( 'Nothing Found', 'sublime' ); ?>
    </h4>
    <p>
      <?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'sublime' ); ?>
    </p>
    <br/>
    <?php  endif;?>
    <div class="span9">
...
'mid_size' => 2,
'prev_next' => True,
'prev_text' => __(' &larr;','reverb'),
'next_text' => __(' &rarr;','reverb'),
...
<div class="span9">
  ...
  <div class="span6">
	...
	echo '</div>';       
        ...
        <?php the_post_thumbnail(); }?>
        <div class="mask">
          <div class="mask"> <a class= "wrapmask" href="<?php the_permalink(); ?>"><span><i class="icon-link maskicons"></i></span></a> </div>
        </div>
      </div>
      <div><a href="<?php the_permalink(); ?>">
        <h4>
