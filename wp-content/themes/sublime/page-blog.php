...
?>
   ...
   while (have_posts()) :
      ...
      <div class=" blog span2"id="postdate<?php echo $i++;?>">
...
echo '<span><i class="fa fa-folder-open"></i> Category: '.trim($output, $separator).'</span>';
} ?>
          <br/>
...
if ($posttags) {?>
      ...
      <div class="span6">
        <div <?php post_class('text'); ?> id="post-<?php the_ID(); ?>">
          <div class="portfolio-project"id="postdate<?php echo $i++;?>">
