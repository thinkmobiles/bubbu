...
<div id="slider">
  ...
  <div class="brandList">   
	<?php if(!empty($logo)):?>
    <a class="brand center" href="<?php echo home_url(); ?>"> <img class="a" src="<?php echo $logo;?>" alt=""> </a>
    <?php endif;?>
    
    <img src="<?php bloginfo('template_directory'); ?>/img/Download-on.png" class="brand title center"/>
    <div class="left">
      <?php if(!empty($android_img)):?>
      <a class="brand" href="<?php echo $ios_url; ?>"> <img class="a" src="<?php echo $ios_img;?>" alt=""> </a>
	  
      <?php endif;?>
    </div>
    <div class="right">
      <?php if(!empty($ios_img)):?>
      <a class="brand" href="<?php echo $android_url; ?>"> <img class="a" src="<?php echo $android_img;?>" alt=""> </a>
